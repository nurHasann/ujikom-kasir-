                        ...
                        <form method="post" >
                            <table class="table table-bordered m-0 font-weight-bold text-primary" >
                                <tr>
                                    ...
                                    <td width="1" >:</td>
                                    <td><input class="from-control w-100" value="<?php echo $data['nama_pelanggan'];?>" type="text"  name="nama_pelanggan" > </td>
                                </tr>
                                <tr>
                                    <td>Alamat</td>
                                    <td>:</td>
                                    <td ><textarea name="alamat" rows="2" class="from-control w-100" ><?php echo $data['alamat'];?> </textarea></td>
                                </tr>
                                <tr>
                                    <td>No. Telepon</td>
                                    <td>:</td>
                                    <td><input type="number" class="from-control w-100" step="0" name="no_telepon"  value="<?php echo $data['no_telepon'];?>"></td>
                                </tr>
                                <tr>
                                <td></td>
                                <td></td>
